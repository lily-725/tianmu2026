...
export const MAP_CONFIG = {
  ...
  COLORS: {
    ...
    AREA: '#FAF2BF',
    MARKERS: {
      religion: POINT_TYPE_META.religion.color,
      economy: POINT_TYPE_META.economy.color,
      education: POINT_TYPE_META.education.color,
      life: POINT_TYPE_META.life.color,
      sports: POINT_TYPE_META.sports.color
    }
  }
};
