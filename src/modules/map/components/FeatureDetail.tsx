...
export const FeatureDetail = ({ feature, onBack, onImageZoom }: FeatureDetailProps) => {
  ...
  const images = useMemo(() => (feature.images ?? []).filter(img => img.url), [feature.images]);
  ...
  return (
    <div 
      className="flex flex-col h-full bg-archive-surface z-50 p-10 overflow-y-scroll archive-scrollbar"
    >
      <div className="flex-1 mx-auto max-w-xs">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 pt-4">
            ...
            >
              <span className="text-base font-bold text-archive-dark tracking-tight">阅读更多，查看天穆的故事</span>
              <motion.span 
                animate={{ x: [0, 5, 0] }}
