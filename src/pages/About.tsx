  ...
  return (
    <div ref={containerRef} className="max-w-[999px] mx-auto relative">
      ...
      <div className="absolute inset-0 pointer-events-none -z-5 overflow-hidden">
        ...
        >
          <img src={withBase('/shuru/tianmudajie1.jpg')} className="w-full h-full object-cover rounded-sm" alt="" />
        </motion.div>
        <motion.div 
          style={{ y: useTransform(scrollYProgress, [0, 1], [0, 120]) }}
          className="absolute top-[60%] -left-32 w-72 h-48 opacity-[0.06] grayscale"
        >
          <img src={withBase('/shuru/caoyun1.jpg')} className="w-full h-full object-cover rounded-sm" alt="" />
        </motion.div>
      </div>
      ...
      >
        ...
        <div className="aspect-[21/9] bg-brand-soft-grey mb-10 overflow-hidden shadow-sm group">
           <img src={withBase('/import/0000.png')} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" alt="Tianmu View" />
        </div>
          ...
          {about.paragraphs.map((p, idx) => (
            <div key={idx} className="relative group">
              {idx === 1 && (
                ...
                >
                  <img src={withBase('/shuru/caoyun2.jpg')} className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="历史照片" />
                </motion.div>
              )}
              {idx === 3 && (
                <motion.div 
                ...
                >
                  <img src={withBase('/shuru/beisi1916.jpg')} className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="历史照片" />
                </motion.div>
              )}
