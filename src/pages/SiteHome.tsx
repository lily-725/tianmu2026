    ...
    <div ref={containerRef} className="home-module-theme relative w-full bg-parchment overflow-x-hidden">
      <div className="fixed inset-0 pointer-events-none z-0">
        <motion.div
          ...
          style={{
            backgroundImage: `url("${withBase('/ditu/qctj.jpg')}")`,
            opacity: mapOpacity
          }}
        />
          ...
          <div className="about-content-wrapper">
            ...
            <div className="about-image-collage relative h-[700px] translate-y-8 md:translate-y-12">
              ...
              <motion.div
                ...
                whileInView={{ rotate: 2, scale: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              <motion.div
                ...
                whileInView={{ rotate: 9, scale: 1, x: 0 }}
                viewport={{ once: true }}
